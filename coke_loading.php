...
<head>
  <meta charset="UTF-8">
  <title>Coca-Cola Loading Animation</title>
	...
	<div id="inner-refresh">
		<div class="bottle-container">
			<svg  version="1.1"
						...
						enable-background="new 0 -131.8 103 503.8"
						xml:space="preserve" >
			...
			<div class="loading-container">
				...
				<span class="loading-counter" >
					<span class="counter">1</span>
				</span>
				<span class="loading-done">Done</span>
			</div>
			
			<a class="reload-demo" href="javascript:void(null)" onclick="reloadFun()">Go</a>
