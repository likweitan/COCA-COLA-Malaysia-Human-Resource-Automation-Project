...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="login.php"><img class="logo-img" src="/assets/images/logo.png" alt="logo" width=100></a><span class="splash-description">Staff</span></div>
            <div class="card-body">
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="signup.php" class="footer-link" style="padding-left: 15px; padding-right: 15px">No Account?</a></div>
                <div class="card-footer-item card-footer-item-bordered">
