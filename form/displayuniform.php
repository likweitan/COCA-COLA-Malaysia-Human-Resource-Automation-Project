...
$query = mysqli_query($con, "SELECT employee.FirstName, employee.LastName, employee.NRIC, employee.Department, employee.Designation, employee.PhoneNo, uniform.PantsSize, uniform.PantsQuantity, uniform.ShirtSize, uniform.ShirtQuantity  FROM uniform 
	INNER JOIN employee on employee.EmployeeId=uniform.EmployeeId WHERE employee.EmployeeId = '1'");
                                ...
                                <div class="card-body">
									...
									<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-minlength="6" placeholder="" value="<?php echo $NRIC;?>"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
