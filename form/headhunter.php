<?php
	...
	$query = mysqli_query($con, "SELECT  employee.FirstName, employee.LastName, employee.AccountNo, employee.Designation, employee.PhoneNo, employee.Department FROM employee
	INNER JOIN account ON account.AccountNo = employee.AccountNo WHERE account.AccountNo='$account'");
	...
	$insert = mysqli_query($con, "INSERT INTO headhunter ( AccountNo, FirstName, LastName,  PositionApply, PhoneNo ) VALUES ('$AccountNo', '$FirstName', '$LastName', '$PositionApply','$PhoneNo')");
	}	
                                    ...
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        ...
                                        <div class="form-group row">
										 ...
										 <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required=""  placeholder="" name="LastName" class="form-control">
                                            </div>
                                        </div>
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Position applied for </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="PositionApply" class="form-control">
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="PhoneNo" class="form-control">
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Employee's Name </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
										...
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Employee's ID </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $AccountNo;?>" class="form-control">
                                            </div>
                                        </div>
										
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Current position </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
										...
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Contact No </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $PhoneNo;?>" class="form-control">
                                            </div>
                                        </div>
										...
										declare that the above information that is valid</span>
                                                    </label>
										</div>
                                        </div>
										</div>
