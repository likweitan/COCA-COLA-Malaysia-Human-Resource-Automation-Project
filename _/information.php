...
<head>
    ...
    <?php
		...
		if($uniform_completed){
			$new_joiner_progress = $new_joiner_progress + 15;
		}
		...
		$sql = "SELECT * FROM education WHERE AccountNo='".$employeeno."'";
		$query = mysqli_query($con,$sql);
		$count = mysqli_num_rows($query);
...
<body>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
												...
												<td>
												<?php
                                                echo "<a href=\"form/uniform_new_joiner.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/uniform_new_joiner.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>2</td>
                                                ...
                                                <td>
												<?php
                                                echo "<a href=\"form/employee_id_form.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/employee_id_form.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>3</td>
												...
												<td>
												<?php
                                                echo "<a href=\"form/vehicle_sticker_request.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/vehicle_sticker_request.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>4</td>
                                                ...
                                                <td>
												<?php
                                                echo "<a href=\"form/job_application_form.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/job_application_form.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>5</td>
                                                ...
                                                <td>
												<?php
                                                echo "<a href=\"form/dependent_medical_benefits_enrolment_form.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/dependent_medical_benefits_enrolment_form.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>6</td>
                                                ...
                                                <td>
												<?php
                                                echo "<a href=\"form/90_day_touchpoint.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/90_day_touchpoint.php?action=insert">Submit</a></td>
                                            </tr>
											<tr>
												<td>7</td>
                                                <td>Income Tax Form</td>
                                                <td></td>
												<td><a href="form/IncomeTax_In.php?action=insert">Submit</a></td>
                                            </tr>
                                            ...
                                            <tr>
												...
												<td><?php
                                                echo "<a href=\"form/be_a_headhunter.php?id=$employeeno&action=view\">";
												...
												<td><a href="form/be_a_headhunter.php?action=insert">Submit</a></td>
                                            </tr>
                                            <tr>
												<td>9</td>
	...
	<script>
		var ctx = document.getElementById('onlinePie');
    	var accountChart = new Chart(ctx, {
    				type: 'pie',
    				data: {
