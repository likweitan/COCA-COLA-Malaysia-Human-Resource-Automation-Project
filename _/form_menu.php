							...
							<div class="card-body">
								<table class="table table-hover">
									...
									<tbody>
										<?php
								switch($form){
									case 'Uniform New Joiner Form':
										$formno='uniform';
										$formname="UniformId";
										$link="uniform_new_joiner.php";
										break;
										case 'Employee ID Form';
										$formno='tag';
										$formname='TagId';
										$link="employee_id_form.php";
										break;
										case 'Vehicle Sticker Request Form';
										$formno='vehicle';
										$formname='Vehicle';
										$link="sticker.php";
										break;
										...
										$formno='account';
										$formname='EmployeeId';
										$link="job_application_form.php";
										break;
										case 'Dependent Medical Benefits Enrollment Form';
										$formno='medical';
										$formname='MedicalId';
										$link="dependent_medical_benefits_enrolment_form.php";
										break;
										case '90 Day Touchpoint Form';
										$formno='survey';
										$formname='SurveyId';
										$link="90_day_touchpoint.php";
										break;
										case 'Income Tax Form';
										$formno='incometax';
										$formname='IncomeTaxId';
										$link="income_tax.php";
										break;
										case 'Be a Headhunter Form';
										$formno='headhunter';
										$formname='HeadHunterID';
										$link="be_a_headhunter.php";
										break;
										case 'ICO Application Form';
										$formno='ico';
										$formname='TagId';
										$link="ico.php";
										break;
												...
												$sql = "SELECT * FROM $formno LEFT JOIN employee ON $formno.AccountNo = employee.AccountNo";
				$result = mysqli_query($con, $sql);
					...
					while($row = mysqli_fetch_array($result)) {
										...
										<tr>
											...
											<?php echo "<td><a href=\"form/$link?id=";
						echo $row[$formname];
						echo "&action=update\">View</a></td>";	 ?>
										</tr>
										<?php $i++;
				}
				?>
