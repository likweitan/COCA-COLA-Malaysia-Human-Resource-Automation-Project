...
if(isset($_POST['submit'])){
	...
	$insert = mysqli_query($con, "INSERT INTO uniform ( EmployeeId, PantsSize, PantsQuantity,  ShirtSize, ShirtQuantity ) VALUES ('$employeeID', '$PantsSize', '$PantsQuantity', '$ShirtSize','$ShirtQuantity')");
	}	
									...
									<div class="form-group row">
										...
										<div class="form-group row">
											...
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="PantsSize" value="S" checked="" class="custom-control-input" ><span class="custom-control-label">S</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="PantsSize" value="M" checked="" class="custom-control-input" ><span class="custom-control-label">M</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="PantsSize" value="L" checked="" class="custom-control-input" ><span class="custom-control-label">L</span>
                                            </label>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="PantsSize" value="XL" checked="" class="custom-control-input" ><span class="custom-control-label">XL</span>
                                            </label>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="PantsSize" value="XXL" checked="" class="custom-control-input" ><span class="custom-control-label">XXL</span>
                                            </label>
											</form>
										</div>
										</div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="PantsQuantity" required="" data-parsley-min="6" placeholder="" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
											...
											<form>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ShirtSize" value="S" checked="" class="custom-control-input" ><span class="custom-control-label">S</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ShirtSize" value="M" checked="" class="custom-control-input" ><span class="custom-control-label">M</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ShirtSize" value="L" checked="" class="custom-control-input" ><span class="custom-control-label">L</span>
                                            </label>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ShirtSize" value="XL" checked="" class="custom-control-input" ><span class="custom-control-label">XL</span>
                                            </label>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ShirtSize" value="XXL" checked="" class="custom-control-input" ><span class="custom-control-label">XXL</span>
                                            </label>
											</form>
										</div>
										</div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="ShirtQuantity" required="" data-parsley-min="6" placeholder="" class="form-control">
                                            </div>
                                        </div>
