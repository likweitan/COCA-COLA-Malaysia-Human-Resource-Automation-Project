...
require "../loginheader.php";
	...
	if($action == 'insert'){
		$actionphp = "ico_application_insert.php";
		$formbutton = 'Submit';
	}
	else if($action == 'update'){
		$actionphp = "ico_application_update.php";
		$formbutton = 'Update';
	}else{
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="form-elements.html">Explore</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="form-validation.html">Form</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="<?php echo $actionphp; ?>" method="post">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required="" name = "PositionApply" placeholder="" class="form-control" value="<?php echo $positionapply;?>">
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required=""  placeholder="" class="form-control" value="<?php echo $fullname;?> disabled">
                                            </div>
                                        </div>
