...
$query = mysqli_query($con, "SELECT employee.NameCard,employee.FirstName, employee.LastName, employee.Department,employee.Designation,employee.AccountNo, employee.Department, employee.Designation, uniform.PantsSize, uniform.PantsQuantity, uniform.ShirtSize, uniform.ShirtQuantity  FROM uniform INNER JOIN employee on employee.AccountNo=uniform.AccountNo WHERE employee.AccountNo = $EmployeeId");
	...
	while($rs = mysqli_fetch_array($query)){
		...
		$Account = $rs['AccountNo'];
		$Department = $rs['Department'];
		$Designation = $rs['Designation'];
		$role=$rs['Role'];
		$PantsSize = $rs['PantsSize'];
		$PantsQuantity = $rs['PantsQuantity'];
		$ShirtSize = $rs['ShirtSize'];
		$ShirtQuantity = $rs['ShirtQuantity'];
	}
		$sql = 'a';
		$query= mysqli_query($con, "SELECT * FROM account WHERE AccountNo= $Account");
		$rows = mysqli_num_rows($query);
			 ...
			 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header d-flex">
                                        <h4 class="card-header-title">Uniform New Joiner</h4>
                                        <div class="toolbar ml-auto">
                                            <button type="button" onclick="printJS('printJS-form', 'html')" class="btn btn-success btn-sm ">Print</button>
                                        </div>
                                    </div>
                                <div class="card-body">
                                    <form data-parsley-validate="" novalidate="" action="#" method="post" id="printJS-form"> 
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-minlength="6" placeholder="" value="<?php echo $Account;?>"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Department </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-maxlength="6" placeholder="" value="<?php echo $Department;?>"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Designation </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-length="[5,10]" placeholder="" value="<?php echo $Designation;?>"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Mobile Number </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-min="6" placeholder="" value="<?php echo $PhoneNo;?>"  class="form-control">
                                            </div>
                                        </div>
                                      
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Pants Size </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text"  required="" data-parsley-min="6" value="<?php echo $PantsSize;?>" placeholder="" class="form-control" >
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="number"  required="" data-parsley-min="6" value="<?php echo $PantsQuantity;?>" placeholder="" class="form-control" >
                                            </div>
                                        </div>
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-left">Shirt Size</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text"  required="" data-parsley-min="6" placeholder="" value="<?php echo $ShirtSize;?>" class="form-control" >
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="number"  required="" data-parsley-min="6" placeholder="" value="<?php echo $ShirtQuantity;?>" class="form-control">
                                            </div>
                                        </div>
