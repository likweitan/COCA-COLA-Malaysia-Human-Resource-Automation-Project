...
include("db.php");
	...
	$LostDate = mysqli_real_escape_string($con, date('Y-m-d', strtotime(str_replace('_','/',$_POST['LostDate']))));
	$insert = mysqli_query($con, "INSERT INTO tag ( EmployeeId, Reason, LostDate) VALUES ('$employeeID','$reason' ,'$LostDate')");
	}
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-sm-left">Reason :</label>
                                            <div class="col-sm-6">
											<form>
											<label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="reason" class="custom-control-input" value="New"><span class="custom-control-label">New</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="reason" class="custom-control-input" value="Replacement"><span class="custom-control-label">Replacement</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="reason" class="custom-control-input" value="Lost"><span class="custom-control-label">Lost</span>
                                            </label>
											</form>
											</div>
										</div>
                                        ...
                                        <div class="input-group date"  id="datetimepicker4" data-target-input="nearest">
                                            <input type="text" name="LostDate" class="form-control datetimepicker-input" data-target="#datetimepicker4">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-checkbox">
                                                        <input id="ck1" name="ck1" type="checkbox" data-parsley-multiple="groups" value="bar" data-parsley-mincheck="2" data-parsley-errors-container="#error-container1" class="custom-control-input"><span class="custom-control-label">i hereby declared the above information is true</span>
                                                    </label>
										</div>
                                        </div>
										</div>
