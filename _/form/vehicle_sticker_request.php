...
if(isset($_POST['submit'])){
	...
	$PlateNo = mysqli_real_escape_string($con, $_POST['vehicle']);
	$insert = mysqli_query($con, "INSERT INTO vehicle (AccountNo, Type, PlateNo) VALUES ('$AccountNo','$Type1', '$PlateNo')");
	if($insert){
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" novalidate="" action="<?=$_SERVER['PHP_SELF']?>" method="POST">
                                        <div class="form-group row">
                                            <label for="type" class="col-3 col-lg-2 col-form-label text-right">Type</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="type" type="text" required="" name="type" data-parsley-type="type" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword2" class="col-3 col-lg-2 col-form-label text-right">Vehicle No</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="vehicle" type="vehicle" required="" name="vehicle" placeholder="" class="form-control">
                                            </div>
                                        </div>
