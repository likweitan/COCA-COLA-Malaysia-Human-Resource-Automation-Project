...
require "../loginheader.php";
	...
	WHERE employee.AccountNo = '$account'");
...
//		$JoinDate = $rs['Mod_Timestamp'];
	...
	$insert = mysqli_query($con, "INSERT INTO survey ( AccountNo, Question1, Question2, Question3, Question4, Question5, Question6) VALUES ('$account','$Question1', '$Question2', '$Question3', '$Question4', '$Question5', '$Question6')");
	}
