<?php
	...
	if($action == 'update'){
		...
		$sql = "SELECT * FROM headhunter WHERE HeadHunterID='".$account_select."'";
		...
		if($row){
			...
			$positionapply = $row['PositionApply'];
			$phoneno = $row['PhoneNo'];
			$resume =$row['Resume'];
		}
	}
		...
		// headhunter
$sql = "SELECT *,DATE_FORMAT(Mod_Timestamp,GET_FORMAT(DATE,'ISO')) AS LostDate FROM headhunter WHERE AccountNo='".$employeeno."' ORDER BY HeadHunterID DESC LIMIT 1";
$query = mysqli_query($con, $sql);
$row = mysqli_fetch_array($query);
...
if($action == 'insert'){
		$actionphp = "be_a_headhunter_insert.php";
		$formbutton = 'Submit';
		
	}
	else if($action == 'update'){
		$actionphp = "be_a_headhunter_update.php?id=$account_select";
		$formbutton = 'Update';
	}
?>
            ...
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Explore</a></li>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">BE A HEAD - HUNTER PROGRAMME APPLICATION FORM</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="<?php echo $actionphp; ?>" method="post" enctype="multipart/form-data">
                                        <h4>I would like to recommend the following candidate to join our company :</h4>
								
									
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">First Name</label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="FirstName" class="form-control" value="<?php echo $first_name;?>">
                                            </div>
                                        </div>
										 ...
										 <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="LastName" class="form-control" value="<?php echo $last_name;?>">
                                            </div>
                                        </div>
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Position applied for </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="PositionApply" class="form-control" value="<?php echo $positionapply;?>">
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" name="PhoneNo" class="form-control" value="<?php echo $phoneno;?>">
                                            </div>
                                        </div>
										...
										echo '<div class="form-group row">
												<label class="col-12 col-sm-3 col-form-label text-sm-right">Resume </label><div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="file" name="resume">
												<p>Attached a copy of the resume of the candidate (if available ).</p>
                                            </div>
										</div>';
										else{
											echo '<div class="form-group row">
											...
											?>
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Employee's Name </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $fullname;?>" class="form-control" disabled>
                                            </div>
                                        </div>
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Employee's ID </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $employeeno;?>" class="form-control" disabled>
                                            </div>
                                        </div>
										
										
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Current position </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $designation;?>" class="form-control" disabled>
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Contact No </label>
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $mobileno;?>" class="form-control" disabled>
                                            </div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                <input type="text" required=""  placeholder="" value="<?php echo $department;?>" class="form-control" disabled>
                                            </div>
                                        </div>
										<?php
