				...
				<nav class="navbar navbar-expand-lg navbar-light">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item ">
								<a class="nav-link active" href="notification.php"><i class="fas fa-bookmark"></i>Notifications</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link deactive" href="social/index.php"><i class="fas fa-sitemap"></i>Album</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link deactive" href="form.php"><i class="fas fa-bookmark"></i>Document</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link deactive" href="#"><i class="fas fa-calendar-alt"></i>Redemption</a>
							</li>
							<li class="nav-item ">
							...
							<li class="nav-item ">
								<a class="nav-link deactive" href="manage_user.php"><i class="fas fa-gamepad"></i>Account Management</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link deactive" href="manage_user.php"><i class="fas fa-gamepad"></i>Document Management</a>
							</li>
							<li class="nav-item ">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
				...
				<!-- ============================================================== -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Number of form submitted</h5>
                            <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="">Uniform New Joiner Form</a></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
											<tr>
											...
											<tr>
                                                <td><a href="form/form-vehicle-registration.html">Vehicle Sticker Request Form</a></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
											<tr>
											...
											<tr>
                                                <td>Dependent Medical Benefits Enrollment Form</td>
                                                <td></td>
                                                <td></td>
                                            </tr>
											<tr>
                                            ...
                                            <tr>
                                                <td><a href="form/ico-application.php">ICO Application Form</a></td>
												<td>a</td>
                                                <td>@twitter</td>
                                            </tr>
                                        </tbody>
