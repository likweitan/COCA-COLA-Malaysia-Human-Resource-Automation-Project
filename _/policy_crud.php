                        ...
                        <div class="page-header">
                            ...
                            <div class="page-breadcrumb">
                                ...
                                <div class="card-header d-flex">
                                        <h4 class="card-header-title">Policy</h4>
                                        <div class="toolbar ml-auto">
                                            <a href="policy/add.php" class="btn btn-success btn-sm ">Add</a>
                                        </div>
                                    </div>
						<div class="card-body">
                                        					...
                                        					<table class="table table-striped table-hover">
                                        						...
                                        						<?php 
																	...
																	include_once("db.php");
																$result = mysqli_query($con, "SELECT * FROM policy ORDER BY PolicyNo ASC");
																	//while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array
																	while($res = mysqli_fetch_array($result)) {
																	echo "<tr>";
																		echo "<td>".$res['PolicyNo']."</td>";
																		echo "<td>".$res['PolicyTitle']."</td>";
																		//echo "<td>".$res['age']."</td>";
																		//echo "<td>".$res['PolicyParagraph']."</td>";
																		echo "<td><a href=\"policy/edit.php?id=$res[PolicyNo]\">Edit</a> | <a href=\"policy/delete.php?id=$res[PolicyNo]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
																		}
																		?>
                                        					</table>
