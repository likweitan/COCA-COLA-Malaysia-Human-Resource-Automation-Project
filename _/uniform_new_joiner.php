...
<head>
	...
	if($role == 'admin' && $account_select != 'insert'){
		$sql = "SELECT * FROM employee WHERE AccountNo='".$account_select."'";
	...
	if($role == 'admin' && $action == 'insert'){
		$actionphp = "employee_id_form_insert.php";
		$formbutton = 'Insert';
		
	}
	else{
		$actionphp = "employee_id_form_update.php";
		$formbutton = 'Update';
	}
	?>
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- ============================================================== -->
			 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card-body">
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-minlength="12" placeholder="" value="<?php echo $employeeno;?>" disabled class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-min="6" placeholder="" value="<?php echo $mobileno;?>" disabled class="form-control">
                                            </div>
                                        </div>
                	...
                	?>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <button class="btn btn-primary" name="submit" type="submit"><?=$formbutton?></button>
                                            </div>
