		...
		<main>
			<header class="codrops-header">
				<div class="codrops-links">
					...
					<a class="codrops-icon codrops-icon--drop" href="#" title=""><svg class="icon icon--drop">
				...
				<div class="grid grid--type-a">
					...
					<?php
						...
						$username = $_SESSION['username'];
							...
							FROM album INNER JOIN employee ON album.AccountNo=employee.AccountNo GROUP BY AlbumId";
