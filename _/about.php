...
<head>
  ...
  <link rel="stylesheet" href="assets/vendor/cocavending/style.css">
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<?php
		...
		//----------------------------
		$sql = "SELECT *,DATEDIFF(Mod_Timestamp,CURRENT_TIMESTAMP()) AS DayDiff FROM point WHERE AccountNo ='". $_SESSION['username']. "' AND Remarks IS NOT NULL";
		$result = mysqli_query($con, $sql);
		$row = mysqli_fetch_array($result);	
		$count = mysqli_num_rows($result);
		$random = rand(100,10000);
		if($count == 0){
			$sql = "INSERT INTO point (AccountNo,Amount,Remarks) VALUES ('$account','$random','special')";
			$result = mysqli_query($con, $sql);
		}
	?>
<body>
      ...
      <div class="machine-overlay-container">
        ...
        <div class="machine-overlay-inner machine-overlay-coke">
          <div class="machine-overlay-bottle">
			...
			<?php
				if($count==0){
				echo '<p class="bottle-line">You have earned</p>';
				echo '<p class="bottle-line">'.$random.'</p>';
				} ?>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.min.js'></script><script  src="assets/vendor/cocavending/script.js"></script>
