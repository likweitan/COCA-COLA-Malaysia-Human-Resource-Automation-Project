				...
				<nav class="navbar navbar-expand-lg navbar-light">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item ">
								<a class="nav-link active bg-dark" href="games.php"><i class="fas fa-gamepad"></i>Games</a>
							</li>
							<?php
							if($role == 'admin')
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="card card-figure has-hoverable">
                                    <!-- .card-figure -->
                                    <a href="hextris/index.html">
                                        <figure class="figure">
                                            <img class="img-fluid" src="assets/images/hextris.png" alt="Card image cap">
                                            <!-- .figure-caption -->
                                            <figcaption class="figure-caption">
                                                <h6 class="figure-title"> Hextris </h6>
                                                <p class="text-muted mb-0"> An addictive puzzle game inspired by Tetris. </p>
                                            </figcaption>
                                        <!-- /.figure-caption -->
                                        </figure>
                                    </a>
