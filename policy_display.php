	...
	<?php 
				...
				$result = mysqli_query($con, $sql);
					$row = mysqli_fetch_array($result);
						...
						$policyparagraph=$row['PolicyParagraph'];
											?>
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <h5 class="card-header"><?=$policytitle;?></h5>
                                <div class="card-body">
                                    <?=$policyparagraph;?>
                                </div>
									</form>
							...
							<button class="btn btn-primary text-center" type="button" onclick="printJS('printJS-form', 'html')">
